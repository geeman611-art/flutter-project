...
vars = {
  ...
  'dart_revision': 'ee5afcef0596c445d182c1cb7fd635e702e47912',
  ...
  'dart_boringssl_rev': '94c4c7f9e0eeeff72ea1ac6abf1aed5bd2a82c0c',
...
deps = {
  ...
  'engine/src/flutter/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@d0d5ccd037cb0eaea8e4dad900946ac54a4286c6',
     ...
     'packages': [
       {
        ...
        'version': 'rB8LAuZL_DwHMssTUX3aga_20Xi1Tn4tQZEkdSUVTeoC'
       }
     ],
