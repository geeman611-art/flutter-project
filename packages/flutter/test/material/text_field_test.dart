...
void main() {
  ...
  testWidgets(
    'TextField uses InputDecorationThemeData.composingStyle when widget composingStyle is null',
    (WidgetTester tester) async {
      const themeComposingStyle = TextStyle(
        color: Colors.grey,
        decoration: TextDecoration.underline,
      );
      const inputDecorationTheme = InputDecorationThemeData(composingStyle: themeComposingStyle);
  ...
  testWidgets(
    'TextField uses InputDecorationThemeData.enableInlinePrediction when widget enableInlinePrediction is null',
    (WidgetTester tester) async {
      const inputDecorationTheme = InputDecorationThemeData(enableInlinePrediction: true);
