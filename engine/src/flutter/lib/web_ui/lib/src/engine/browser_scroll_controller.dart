...
class BrowserScrollController {
  ...
  void _detachPlatformViewTouchChaining() {
    ...
    if (_pvTouchStartListener != null) {
      root.removeEventListener('touchstart', _pvTouchStartListener);
      root.removeEventListener('touchmove', _pvTouchMoveListener);
      root.removeEventListener('touchend', _pvTouchEndListener);
      root.removeEventListener('touchcancel', _pvTouchEndListener);
